# ------------------------------------------------------------------------------
# Live Test server 1 Security Group and rules
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Live Test Server 1 CloudWatch
# ------------------------------------------------------------------------------

resource "aws_cloudwatch_log_group" "live_test_1" {
  for_each = local.live_test_1_cw_logs
...
module "live_test_1_ec2" {
  ...
  ami                    = var.live_test_1_ami
  instance_type          = var.live_test_1_ec2_instance_size

...
| [aws_cloudwatch_log_group.live_test_1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_log_group) | resource |
...
| [aws_key_pair.live_test_1_keypair](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/key_pair) | resource |
| [aws_security_group.bus_obj_1_server_web_sg](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group) | resource |
...
| [vault_generic_secret.live_test_1_ec2_data](https://registry.terraform.io/providers/hashicorp/vault/latest/docs/data-sources/generic_secret) | data source |
...
| <a name="input_live_test_1_ami"></a> [live\_test\_1\_ami](#input\_live\_test\_1\_ami) | ID of the AMI to use for instance | `string` | n/a | yes |
| <a name="input_live_test_1_application"></a> [live\_test\_1\_application](#input\_live\_test\_1\_application) | EC2 application description | `string` | n/a | yes |
| <a name="input_live_test_1_cw_logs"></a> [live\_test\_1\_cw\_logs](#input\_live\_test\_1\_cw\_logs) | Map of log file information; used to create log groups, IAM permissions and passed to the application to configure remote logging | `map(any)` | `{}` | no |
| <a name="input_live_test_1_ec2_instance_size"></a> [live\_test\_1\_ec2\_instance\_size](#input\_live\_test\_1\_ec2\_instance\_size) | The size of the EC2 instance | `string` | n/a | yes |
| <a name="input_live_test_1_ec2_name"></a> [live\_test\_1\_ec2\_name](#input\_live\_test\_1\_ec2\_name) | EC2 instance name | `string` | n/a | yes |

...
module "ewok_lic_bac_ec2" {
  ...
  key_name               = aws_key_pair.ewok_lic_bac_keypair.key_name
  monitoring             = var.monitoring
  get_password_data      = var.get_password_data
  vpc_security_group_ids = [module.ewok_lic_bac_ec2_security_group.this_security_group_id, data.aws_security_group.nagios_shared.id, data.aws_security_group.rdp_shared.id]

...
# ------------------------------------------------------------------------------
# Live smartv_1 Variables
# ------------------------------------------------------------------------------

variable "smartv_1_application" {
  description = "EC2 application description"
  type        = string
}

variable "smartv_1_ec2_name" {
  description = "EC2 instance name"
  type        = string
}

variable "smartv_1_ec2_instance_size" {
  type        = string
  description = "The size of the EC2 instance"
}

variable "smartv_1_ami" {
  type        = string
  description = "ID of the AMI to use for instance"
}

variable "smartv_1_cw_logs" {
  type        = map(any)
  description = "Map of log file information; used to create log groups, IAM permissions and passed to the application to configure remote logging"
  default     = {}
}
...
# ------------------------------------------------------------------------------
# Live doc1da Variables
# ------------------------------------------------------------------------------

variable "doc1da_application" {
  description = "EC2 application description"
  type        = string
}

variable "doc1da_ec2_name" {
  description = "EC2 instance name"
  type        = string
}

variable "doc1da_ec2_instance_size" {
  type        = string
  description = "The size of the EC2 instance"
}
...
# ------------------------------------------------------------------------------
# Live doc1pg Variables
# ------------------------------------------------------------------------------

variable "doc1pg_application" {
  description = "EC2 application description"
  type        = string
}

variable "doc1pg_ec2_name" {
  description = "EC2 instance name"
  type        = string
}

variable "doc1pg_ec2_instance_size" {
  type        = string
  description = "The size of the EC2 instance"
}
...
# ------------------------------------------------------------------------------
# Live doc1tdg Variables
# ------------------------------------------------------------------------------

variable "doc1tdg_application" {
  description = "EC2 application description"
  type        = string
}

variable "doc1tdg_ec2_name" {
  description = "EC2 instance name"
  type        = string
}

variable "doc1tdg_ec2_instance_size" {
  type        = string
  description = "The size of the EC2 instance"
}

variable "doc1tdg_ami" {
  type        = string
  description = "ID of the AMI to use for instance"
}

variable "doc1tdg_cw_logs" {
  type        = map(any)
  description = "Map of log file information; used to create log groups, IAM permissions and passed to the application to configure remote logging"
  default     = {}
}
...
# ------------------------------------------------------------------------------
# Live smartv_3 Variables
# ------------------------------------------------------------------------------

variable "smartv_3_application" {
  description = "EC2 application description"
  type        = string
}

variable "smartv_3_ec2_name" {
  description = "EC2 instance name"
  type        = string
}

variable "smartv_3_ec2_instance_size" {
  type        = string
  description = "The size of the EC2 instance"
}

variable "smartv_3_ami" {
  type        = string
  description = "ID of the AMI to use for instance"
}

variable "smartv_3_cw_logs" {
  type        = map(any)
  description = "Map of log file information; used to create log groups, IAM permissions and passed to the application to configure remote logging"
  default     = {}
}
...
module "bus_obj_2_ec2_security_group" {
  ...
  ingress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 49377
      protocol    = "tcp"
      cidr_blocks = join(",", local.ingress_cidr_blocks_bus_obj["49377_cidr_block"])
    },
    {
      from_port   = 58543
      to_port     = 58543
      protocol    = "tcp"
      cidr_blocks = join(",", local.ingress_cidr_blocks_bus_obj["58543_cidr_block"])
    },
    {
      from_port   = 58577
      to_port     = 58577
      protocol    = "tcp"
      cidr_blocks = join(",", local.ingress_cidr_blocks_bus_obj["58577_cidr_block"])
    },
    {
      rule        = "http-8080-tcp"

...
module "doc_sim_ec2" {
  ...
  vpc_security_group_ids = [module.doc_sim_ec2_security_group.this_security_group_id, data.aws_security_group.nagios_shared.id, data.aws_security_group.rdp_shared.id]

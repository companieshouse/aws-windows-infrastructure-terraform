...
data "vault_generic_secret" "test_2019_1_ec2_data" {
  path = "applications/${var.aws_account}-${var.aws_region}/${var.application}/test-2019-1/ec2"
}

data "vault_generic_secret" "test_2019_2_ec2_data" {
  path = "applications/${var.aws_account}-${var.aws_region}/${var.application}/test-2019-1/ec2"
}

data "vault_generic_secret" "test_2025_1_ec2_data" {
#  path = "applications/${var.aws_account}-${var.aws_region}/${var.application}/test_2025_1/ec2"   # Needs a passsword in the vault ?
  path = "applications/${var.aws_account}-${var.aws_region}/${var.application}/test_2025_1/ec2"
}
